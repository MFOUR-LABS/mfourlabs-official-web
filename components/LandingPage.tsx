...
import { SentinelEUSection } from './SentinelEUSection';
import { AdversarialTestingSection } from './AdversarialTestingSection';
import { RoadmapSection } from './RoadmapSection';
import { LabRegistration } from './LabRegistration';
import { Menu, X, ExternalLink, Globe, ShieldCheck } from 'lucide-react';
        ...
        >
          <div className={`
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              {/* Audit View Link */}
              <Link to="/audit" className="px-4 py-2 text-sm font-medium text-brand-gray hover:text-brand-white transition-colors hover:bg-white/5 rounded-full">Audit View</Link>
            </div>
